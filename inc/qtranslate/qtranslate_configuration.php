...
<div class="form-field">
	...
	<?php 
	$files = array();
	if($dir_handle = @opendir($q_config['flag_location'])) {
			...
			<tr>
				...
				<?php
					foreach ( qtrans_getSortedLanguages() as $key => $language ) {
						...
						echo ' />';
						echo ' <a href="'.add_query_arg('moveup', $language, $clean_uri).'"><img src="'.get_stylesheet_directory_uri(). '/inc/qtranslate/arrowup.png" alt="up" /></a>';
						echo ' <a href="'.add_query_arg('movedown', $language, $clean_uri).'"><img src="'.get_stylesheet_directory_uri(). '/inc/qtranslate/arrowdown.png" alt="down" /></a>';
